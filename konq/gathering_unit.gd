...
func setup(unit_name, unit_desc, income, unit_img, material_img, upgrade_cost):
	...
	$vbox/MarginContainer/Panel/MarginContainer/HBoxContainer/VBoxContainer2/B_UPGRADE.text="%s Upgrade"%upgrade_cost
	$vbox/MarginContainer/Panel/MarginContainer/HBoxContainer/VBoxContainer/UNIT_HOWMUCH.text=HOWMUCH_FMT%[unit_name, income, material_img]
